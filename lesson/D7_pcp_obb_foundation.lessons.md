...
审计基线：当前主线 `ziyu24/D7_pcp_obb_foundation@0eab5d26d7b6900a10e486cec3a69d49ac52d0c0`。已抓取并检查全部远端分支，没有更新更晚的次线。最新纸面证据将有合法上界的主动 signed 审核归约到已有加权有限总体框架，保留抽样信息和成本；尚无新的空间/代价机制，不启动真实数据验证。此前同尺度基线与计数查询支配证据保留；旧原型保持停止，已有开发样本上的复算仍是事后诊断，不是独立确认。

快速阅读路径：先读“项目研究什么”→“教训十三、十四、十五”→“教训一、二、三、八、九、十、十一、十二”→“方法族停止索引”。
