...
全部关闭无监督的简单策略有明显局部负证据；固定教师×规律半量的延长窗口出现局部正信号，但同质量总成本、跨种子稳定性、收敛速度或创新尚未成立。共同19200父态后三动作中，继续旧监督60.8289%，高于暂停58.6367%及换当前教师后固定60.2086%。较早12800共同父态的四格及关闭控制现已完成：19200时关闭52.0781%、旧教师半量60.2546%、当前教师半量59.7924%、旧教师全量60.2006%、当前教师全量58.4812%。刷新相对旧教师在半量和全量下都从16000的正差变为19200的负差；当前全量合法best在16000。它加强“较高/较新的教师并非必然有更高教学收益”的经验边界，但不证明刷新一般有害或给出可部署规则。固定模型图像敏感性与训练稳定性、总体显著性仍不可混同。已抓取来源全部远端分支，仅有main，无更新更晚次线；不审计其他项目。
