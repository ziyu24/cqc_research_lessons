...
- 用户明确接受独立PF-RPN公开检测预训练，固定其原生提案接SAM单掩码OBB，并以同PF水平框和SAM自动掩码为匹配控制；零训练、固定458开发图/5297窗口、known输出、每图300总框和完整GT评价。三输出均完成两卡预测与评价，不用GT选择候选。
...
| PF-RPN提案＋SAM OBB强先验前端 | 总TP、non-tank和类别广度提升但small大幅下降，不扫描提示、尺寸、阈值、预算或种子挽救 | 其他独立对象先验；不应将本比较写成弱监督创新 |
