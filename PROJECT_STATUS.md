...
| P25（`cqc_P25`） | 没有完整OBB标注源域，仅有部分HBox或Point图像与完全无标签图像，如何学习对训练不可见目标域泛化的旋转检测器。 | 正在运行 | 2026-09-25 | 原问题与授权不变。普通多尺度诊断域AP50从11.461到15.550；固定一致性筛选仍未定。按图留出的两个固定线性校准器已完成且全部独立重算一致，均未达预定质量幅度，停止该固定评分器训练投入，不推断质量信息为零或一般可靠性失败。跨尺度教师几何搬运已交付，尚无正式结果；项目目标未达成。[来源证据](https://github.com/ziyu24/cqc_P25/blob/2c7d84dad181f5a17786fe684d1f695f3a5d633a/lab/result.md)、[当前问题](https://github.com/ziyu24/cqc_P25/blob/2c7d84dad181f5a17786fe684d1f695f3a5d633a/lab/discussion.md)。 |
