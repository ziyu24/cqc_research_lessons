...
| P24（`cqc_P24`） | 在部分弱监督旋转检测中，区分继续学习、刷新监督与暂时跳过的边际收益，降低达到同等检测质量的总计算成本。 | 正在运行 | 2026-09-23 | 按已提交原问题补正此前初始化占位；已完成早期学习及静态计算/教师对照，局部省时存在但同质量总成本目标未达成。延长既有轨迹待执行。[原问题与核验](https://github.com/ziyu24/cqc_P24/blob/2ba4e6faa226857d5ca3e91f08b3ec27b12f038d/lab/discussion.md)；[结果证据](https://github.com/ziyu24/cqc_P24/blob/2ba4e6faa226857d5ca3e91f08b3ec27b12f038d/lab/result.md)。 |
