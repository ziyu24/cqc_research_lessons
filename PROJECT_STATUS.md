...
| P24（`cqc_P24`） | 尚未明确立题；已读README与讨论页仍为初始化模板，不能编造科学问题。 | 正在运行 | 2026-09-21 | 用户2026-09-21明确告知项目仍在推进；本次服务器接入核验仅见指定项目目录为空，未核实训练运行。[原问题登记依据](https://github.com/ziyu24/cqc_P24/blob/158eb8d4bbf3ddcc250d8afaa7d6b24047c688f2/lab/discussion.md)；科学问题沿用原登记，等待项目补齐已提交依据。 |
