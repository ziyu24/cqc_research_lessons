...
| P19（`cqc_P19`） | 少量图像仅给已知类Point/HBox、其余无标签时，如何检测已知/未知OBB、区分难已知与新类，并在弱标签揭示后增量学习。 | 失败 | 2026-09-20 | 固定同源外部对象正支持/伪OBB三臂未过低误报投入门槛；[来源结果](https://github.com/ziyu24/cqc_P19/blob/ba7ef243501428d398353b88edde06db70f5b67b/lab/result.md)。 |
