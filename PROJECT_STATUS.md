...
| P26（`cqc_P26`） | 全部源图仅有少量HBB或点、实例整体不完整时，能否学习对未知域泛化的旋转检测器，并提炼跨域通用的因果本质特征。 | 正在运行 | 2026-09-25 | 固定模型的源域背景敏感性诊断已完成，按原条件不可判；框外对比度使稀疏模型丢4个但新增15个检出，AP50反升3.321点，不能把局部损失认作总体受损或背景因果。原目标未达成，路线尚不可判。已交付同32k父状态的普通外观增强与等量原样续训对照，尚未执行。[问题与下一步](https://github.com/ziyu24/cqc_P26/blob/3b615203407b6ca1f2e363df72d8a8949feba22a/lab/discussion.md)、[已核结果](https://github.com/ziyu24/cqc_P26/blob/3b615203407b6ca1f2e363df72d8a8949feba22a/lab/result.md)。 |
