...
| P25（`cqc_P25`） | 没有完整OBB标注源域，仅有部分HBox或Point图像与完全无标签图像，如何学习对训练不可见目标域泛化的旋转检测器。 | 正在运行 | 2026-09-25 | 原问题与用户授权不变。普通多尺度诊断域AP50从11.461到15.550；固定一致性筛选15.675，对置信度/随机增量未达推进条件但未触发严格否定，结论未定。三臂及完整预测已独立核验；已有HBox的冻结信号诊断已交付、零训练且尚无结果。目标未达成，跨种子/严格盲域未验证。[已核证据](https://github.com/ziyu24/cqc_P25/blob/ae5a6951e42f4a46c1d2c439e508ad733bb6c9b0/lab/result.md)、[当前问题](https://github.com/ziyu24/cqc_P25/blob/ae5a6951e42f4a46c1d2c439e508ad733bb6c9b0/lab/discussion.md)。 |
