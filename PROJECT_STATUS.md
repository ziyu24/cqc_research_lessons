...
| P24（`cqc_P24`） | 在部分弱监督旋转检测中，区分继续学习、刷新监督与暂时跳过的边际收益，降低达到同等检测质量的总计算成本。 | 正在运行 | 2026-09-24 | 19200四格已完整核验：固定全量59.8664%、固定半量60.2546%，半量阶段省时13.44%，交互仅+0.0703个百分点，仍为单种子局部证据。共同成熟状态的三动作对照已交付，尚无结果；原同质量总成本目标未达成。[原问题与核验](https://github.com/ziyu24/cqc_P24/blob/f5d5676713da32b19a040a5381faaa87df6945cc/lab/discussion.md)；[结果证据](https://github.com/ziyu24/cqc_P24/blob/f5d5676713da32b19a040a5381faaa87df6945cc/lab/result.md)。 |
