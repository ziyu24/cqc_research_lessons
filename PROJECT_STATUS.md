...
| P24（`cqc_P24`） | 在部分弱监督旋转检测中，区分继续学习、刷新监督与暂时跳过的边际收益，降低达到同等检测质量的总计算成本。 | 正在运行 | 2026-09-24 | 同一19200成熟状态后三动作已完整核验：暂停58.6367%、继续旧监督60.8289%、刷新60.2086%；继续旧监督比暂停高2.1922个百分点，比刷新高0.6203，仅为选定状态单种子窗口结果。下一步固定模型图像敏感性诊断已交付、未执行；自适应路线尚未实现，原同质量总成本目标未达成。[原问题与核验](https://github.com/ziyu24/cqc_P24/blob/5002e537c7c5c6c5f74f0845dacbaa49cf8f4636/lab/discussion.md)；[结果证据](https://github.com/ziyu24/cqc_P24/blob/5002e537c7c5c6c5f74f0845dacbaa49cf8f4636/lab/result.md)。 |
