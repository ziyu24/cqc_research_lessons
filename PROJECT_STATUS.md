...
| P24（`cqc_P24`） | 在部分弱监督旋转检测中，区分继续学习、刷新监督与暂时跳过的边际收益，降低达到同等检测质量的总计算成本。 | 正在运行 | 2026-09-24 | 成熟状态三动作及固定模型图像敏感性已完整核验：继续旧监督60.8289%，暂停58.6367%，刷新60.2086%；逐一删图排序不变，配对整图重采样范围均跨零，不能判训练稳定性。较早12800共同状态的单臂刷新对照已交付、未执行；自适应路线尚未实现，原同质量总成本目标未达成。[原问题与核验](https://github.com/ziyu24/cqc_P24/blob/af29514ed1563741ab52eb2c6d067dca74f68910/lab/discussion.md)；[结果证据](https://github.com/ziyu24/cqc_P24/blob/af29514ed1563741ab52eb2c6d067dca74f68910/lab/result.md)。 |
