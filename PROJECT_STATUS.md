...
| P25（`cqc_P25`） | 没有完整OBB标注源域，仅有部分HBox或Point图像与完全无标签图像，如何学习对训练不可见目标域泛化的旋转检测器。 | 正在运行 | 2026-09-25 | 原问题与用户授权不变。共同初态尺度及L/U位置消融已完整核验，HBox端缩放贡献较大；普通多尺度诊断域AP50从11.461提高到15.550。目标未达成，可靠性机制及等配额置信度/随机对照已交付但未训练，跨种子和严格盲域未验证。[已核证据及边界](https://github.com/ziyu24/cqc_P25/blob/4d6024673013b3a137d9749e92ffea2103ff74bc/lab/result.md)、[当前问题](https://github.com/ziyu24/cqc_P25/blob/4d6024673013b3a137d9749e92ffea2103ff74bc/lab/discussion.md)。 |
