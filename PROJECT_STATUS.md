...
| P26（`cqc_P26`） | 全部源图仅有少量HBB或点、实例整体不完整时，能否学习对未知域泛化的旋转检测器，并提炼跨域通用的因果本质特征。 | 正在运行 | 2026-09-26 | 冻结输出八组完整重放通过；DIOR理想删全部FP后固定召回仅20.075%–24.302%，背景型FP删除也不能消除弱框原位的源域负差。固定空间配置失败及普通增强有限正结果保持；原目标未达成，背景机制与因果命题未知。已交付两模型完整原生候选链定位，零新增训练，尚无完整诊断结果。[当前问题](https://github.com/ziyu24/cqc_P26/blob/e7130d438035ae79a2643532db1933ab57760fcc/lab/discussion.md)、[已核结果](https://github.com/ziyu24/cqc_P26/blob/e7130d438035ae79a2643532db1933ab57760fcc/lab/result.md)。 |
