...
| P26（`cqc_P26`） | 全部源图仅有少量HBB或点、实例整体不完整时，能否学习对未知域泛化的旋转检测器，并提炼跨域通用的因果本质特征。 | 正在运行 | 2026-09-25 | 普通增强修正短续训的源/既有外域AP50增量+3.362/+0.498点保留；后续固定框外敏感性两条件未共同降低，等权−0.108点且区间跨零，未支持该机制解释。原目标未达成，整体背景路线未知；单seed、共同历史前缀及已访问诊断域限制保持。弱框原位与同面积错位训练对照已交付，尚无性能结果。[当前问题](https://github.com/ziyu24/cqc_P26/blob/574286b641399fd2c090550dab2672982bebf2ec/lab/discussion.md)、[已核结果](https://github.com/ziyu24/cqc_P26/blob/574286b641399fd2c090550dab2672982bebf2ec/lab/result.md)。 |
