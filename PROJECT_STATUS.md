...
| P25（`cqc_P25`） | 没有完整OBB标注源域，仅有部分HBox或Point图像与完全无标签图像，如何学习对训练不可见目标域泛化的旋转检测器。 | 正在运行 | 2026-09-25 | 原问题与授权不变。普通多尺度诊断域AP50从11.461到15.550；固定一致性筛选未达推进条件。冻结弱标签诊断对置信度质量增量仅0.00218、一个尺度少22/259对象支持，完整重算一致，预定结论仍未定。停止同一手工信号追加训练，固定弱标签校准及按图留出检验已交付、尚未正式拟合；目标未达成。[来源证据](https://github.com/ziyu24/cqc_P25/blob/5bc8594842788e9dba0ddd09c9479ea886cc8d41/lab/result.md)、[当前问题](https://github.com/ziyu24/cqc_P25/blob/5bc8594842788e9dba0ddd09c9479ea886cc8d41/lab/discussion.md)。 |
